...
export const metadata: Metadata = {
  title: "Coach Nick | Elite SAT/ACT Test Prep | Princeton Educated",
  ...
  keywords: ["SAT prep", "ACT prep", "test preparation", "Princeton tutor", "college admissions", "elite tutoring", "SAT tutor", "ACT tutor"],
  authors: [{ name: "Coach Nick" }],
  openGraph: {
    title: "Coach Nick | Elite SAT/ACT Test Prep",
